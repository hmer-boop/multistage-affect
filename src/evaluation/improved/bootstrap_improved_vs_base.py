...
BASE_REGISTRY_PATH = PROJECT_ROOT / "src" / "evaluation" / "base" / "run_eval_center.py"
ARTTIDE_REGISTRY_PATH = PROJECT_ROOT / "src" / "evaluation" / "improved" / "run_eval_center.py"
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default=str(PROJECT_ROOT / "outputs" / "bootstrap_outputs"))
