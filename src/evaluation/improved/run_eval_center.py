...
MODEL_REGISTRY: Dict[int, Dict[str, Any]] = {
    ...
    # 1. GPT-4o improve
    # 位置：
    # PythonProject/outputs/method_data/
    # 特殊说明：
    # GPT-4o improve 不在 result gpt_stage1/2/3 里面，而是在 method_data 里
    # =========================================================================
    1: {
        "name": "GPT-4o-improve",
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "outputs" / "method_data"
    ...
    2: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "improved" / "gemini" / "gemini_2_5_pro" / "batch"
    ...
    # 位置：
    # src/inference/improved/internvl/8b/
    # =========================================================================
    3: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "improved" / "internvl" / "8b"
    ...
    # 位置：
    # src/inference/improved/llava/4b_instruct/
    # =========================================================================
    4: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "improved" / "llava" / "4b_instruct"
    ...
    # 位置：
    # src/inference/improved/qwen_vl/8b_instruct/
    # 注意：
    ...
    5: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "improved" / "qwen_vl" / "8b_instruct"
...
METRIC_SCRIPTS: Dict[str, Dict[str, str]] = {
    '9.1': {'name': 'Stage label accuracy + TSMR', 'script': 'stage_label_accuracy_tsmr.py'},
    '9.2a': {'name': 'One-stage polarity accuracy', 'script': 'one_stage_polarity_accuracy.py'},
    '9.2b': {'name': 'Three-stage polarity all consistency', 'script': 'three_stage_polarity_consistency.py'},
    '9.3': {'name': 'Three-stage polarity accuracy', 'script': 'three_stage_polarity_accuracy.py'},
    '9.4': {'name': 'Three-stage multi-label accuracy', 'script': 'three_stage_multi_label_accuracy.py'},
    '9.5': {'name': 'Stage2→3 gradient consistency rate', 'script': 'stage2_to_3_gradient_consistency_rate.py'},
    '9.6': {'name': 'Context supplement gain rate', 'script': 'context_supplement_gain_rate.py'},
    '9.7': {'name': 'Strict Trajectory Accuracy (STA)', 'script': 'strict_trajectory_accuracy.py'},
    '9.8': {'name': 'Context Regression Rate (CRR)', 'script': 'context_regression_rate.py'},
}
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Improved-setting evaluation center: choose one model and run selected metrics.')
