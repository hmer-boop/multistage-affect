...
MODEL_REGISTRY: Dict[int, Dict[str, Any]] = {
    ...
    2: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "gemini" / "gemini_2_5_pro" / "batch" / "result Gemini_stage1" / "results_stage1.json"
        ),
        "pred_stage1_round2": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "gemini" / "gemini_2_5_pro" / "batch" / "result Gemini_stage1" / "results_stage1_round2.json"
        ),

        "pred_stage2": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "gemini" / "gemini_2_5_pro" / "batch" / "result Gemini_stage2" / "results_stage2.json"
        ),
        "pred_stage2_round2": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "gemini" / "gemini_2_5_pro" / "batch" / "result Gemini_stage2" / "results_stage2_round2.json"
        ),

        "pred_stage3": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "gemini" / "gemini_2_5_pro" / "batch" / "result Gemini_stage3" / "results_stage3.json"
        ),
        "pred_stage3_round2": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "gemini" / "gemini_2_5_pro" / "batch" / "result Gemini_stage3" / "results_stage3_round2.json"
        ),
    ...
    3: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "internvl" / "8b"
    ...
    4: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "internvl" / "38b"
    ...
    5: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "qwen_vl" / "8b_instruct"
    ...
    6: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "qwen_vl" / "32b_instruct"
    ...
    7: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "llava" / "4b_instruct"
    ...
    8: {
        ...
        "pred_stage1": str(
            PROJECT_ROOT / "src" / "inference" / "base" / "llava" / "8b_instruct"
...
METRIC_SCRIPTS: Dict[str, Dict[str, Any]] = {
    "9.1": {
        ...
        "script": "stage_label_accuracy_tsmr.py",
    },
    "9.2a": {
        "name": "One-stage polarity accuracy",
        "script": "one_stage_polarity_accuracy.py",
    },
    "9.2b": {
        "name": "Three-stage polarity all consistency",
        "script": "three_stage_polarity_consistency.py",
    },
    "9.3": {
        "name": "3-stage polarity accuracy",
        "script": "three_stage_polarity_accuracy.py",
    },
    "9.4": {
        "name": "3-stage multi-label accuracy",
        "script": "three_stage_multi_label_accuracy.py",
    },
    "9.5": {
        "name": "stage2->3 gradient consistency rate",
        "script": "stage2_to_3_gradient_consistency_rate.py",
    },
    "9.6": {
        "name": "context supplement gain rate",
        "script": "context_supplement_gain_rate.py",
    },
    "9.7": {
        "name": "Strict Trajectory Accuracy (STA)",
        "script": "strict_trajectory_accuracy.py",
    },
    "9.8": {
        "name": "Context Regression Rate (CRR)",
        "script": "context_regression_rate.py",
    },
}
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Baseline evaluation center: choose one model and run selected metrics.")
