...
The improved setting reads cue/context files from `outputs/method_data/` when running a full local experiment. The included `examples/demo_predictions/` folder provides a no-API metric check path for reviewers.
