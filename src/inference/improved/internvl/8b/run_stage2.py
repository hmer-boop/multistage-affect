# -*- coding: utf-8 -*-
"""
Stage2 Improve (InternVL 8B):
云端图 URL + stage2_cues(辅助证据) -> 8类情感单标签（调优后的打标）
...
CUES_PATH     = PROJECT_ROOT / "outputs" / "method_data" / "stage2_cues.json"
...
OUT_JSON = OUT_DIR / "stage2_internvl8b_labels4.json"
# =========================
# 0.1) 运行数量控制
# =========================
# 设为 5 / 100 / None(全量)
...
PROMPT_VERSION = "stage2_scene_assisted_v1_internvl"
...
def main():
    ...
    print("=====================================")
    print("Stage2 Improve / InternVL 运行信息")
    ...
    elapsed = time.time() - t0
    print("\n=====================================")
    print("🎯 Stage2 Improve / InternVL 完成")
