...
5) 支持断点续跑
6) 兼容已有单图版 stage3 improve 输出，并同步合并到当前 batch 输出中
"""
...
def parse_args():
    ...
    ap.add_argument("--legacy_result_json", default=str(LEGACY_RESULT_JSON_DEFAULT), help="已有 stage3 improved 结果 json，用于跳过已完成样本")
