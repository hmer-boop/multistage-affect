...
# ===== 原始输出 =====
TXT_OUT = OUT_DIR / "results_stage2_qwen8b.txt"
JSON_OUT = OUT_DIR / "results_stage2_qwen8b.json"
REPORT_PATH = OUT_DIR / "missing_report_stage2_qwen8b.json"
LOCK_PATH = OUT_DIR / ".results_stage2_qwen8b.lock"

TXT_OUT_ROUND2 = OUT_DIR / "results_stage2_qwen8b_round2.txt"
JSON_OUT_ROUND2 = OUT_DIR / "results_stage2_qwen8b_round2.json"
REPORT_PATH_ROUND2 = OUT_DIR / "missing_report_stage2_qwen8b_round2.json"
LOCK_PATH_ROUND2 = OUT_DIR / ".results_stage2_qwen8b_round2.lock"
...
def run_one_dataset(
    ...
    if not dashscope_api_key:
        raise RuntimeError(
            ...
            "请在 PyCharm 的 Run Configuration 里配置环境变量。"
        )
...
def main():
    ...
    print("[debug] INPUT_PATH_ROUND2 =", INPUT_PATH_ROUND2, "exists =", INPUT_PATH_ROUND2.exists(), "loaded =",
          len(items_round2))
