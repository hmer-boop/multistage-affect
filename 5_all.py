...
"""
一键跑全流程：
1) 运行 1_clean_data_caption.py -> 生成 items.jsonl、双语标题与清晰图 dataset/images_raw
2) 运行 3_extract_min_fields.py -> 生成 items_min.jsonl
3) 运行 4_run_describe.py       -> 生成 items_with_captions.jsonl
...
def main():
    ...
    parser.add_argument("--skip1", action="store_true", help="跳过 Step1 1_clean_data_caption.py")
    parser.add_argument("--skip3", action="store_true", help="跳过 Step2 3_extract_min_fields.py")
    parser.add_argument("--skip4", action="store_true", help="跳过 Step3 4_run_describe.py")
    ...
    step1 = BASE_DIR / "1_clean data caption.py"
    step3 = BASE_DIR / "3_extract_min_fields.py"
    step4 = BASE_DIR / "4_run describe.py"
    ...
    if not args.skip4:
        ...
        # 兼容你之前在 4_run_describe.py 里的 argparse 设计
