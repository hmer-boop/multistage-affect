# -*- coding: utf-8 -*-
"""
Stage1 Improve (LLaVA 4B Instruct):
云端图 URL + stage1_cues(辅助证据) -> 8类情感单标签（短时观看模拟，LLaVA 4B）
...
OUT_JSON = OUT_DIR / "stage1_llava4b_labels4.json"
...
PROMPT_VERSION = "stage1_glance_v1_llava4b"
...
def main():
    ...
    print("=====================================")
    print("Stage1 Improve / LLaVA 4B 运行信息")
    ...
    elapsed = time.time() - t0
    print("\n=====================================")
    print("🎯 Stage1 Improve / LLaVA 4B 完成")
