...
- Baseline, improved, COT, and ablation evaluation scripts.
...
- Full raw artwork images.
- Full metadata, full gold labels, and complete prediction result files.
- Earlier local annotation variants, annotation working files, and manually curated labeling artifacts.
- Data scraping, acquisition, cleaning, upload, and hosting scripts.
