# -*- coding: utf-8 -*-
"""
Stage3 Improve (InternVL 8B):
云端图 URL + 标题 + stage2_label + text_label/text_trigger/text_confidence
-> 最终 8 类情感单标签（label-only 输出）

对应你 GPT 的 4.2_build_stage3_lable3✅ 思路，但迁移到 InternVL：
...
输入：
- PROJECT_ROOT / "01improvement method" / "method data" / "stage3_all_information.json"

输出：
- 当前脚本目录 / "result internvl_stage3" / "stage3_internvl8b_labels3.json"
"""
...
OUT_JSON = OUT_DIR / "stage3_internvl8b_labels3.json"
...
PROMPT_VERSION = "stage3_fusion_label_only_v1_internvl"
...
def main():
    ...
    print("=====================================")
    print("Stage3 Improve / InternVL 运行信息")
    ...
    elapsed = time.time() - t0
    print("\n=====================================")
    print("🎯 Stage3 Improve / InternVL 完成")
